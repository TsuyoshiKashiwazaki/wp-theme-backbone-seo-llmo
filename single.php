                    ...
                    ?>
                        <div class="entry-meta">
                            ...
                            <?php if ($show_tags && has_tag()) : ?>
                                ...
                                if ($remaining > 0) :
                                ?>
                                    <button class="meta-badge tags-more-btn" onclick="this.previousElementSibling.querySelectorAll ? Array.from(document.querySelectorAll('.tags-hidden')).forEach(el => el.style.display='inline-block') : ''; this.style.display='none';">
                                        +<?php echo $remaining; ?>
                                    </button>
                                <?php endif; ?>
                            <?php endif; ?>
