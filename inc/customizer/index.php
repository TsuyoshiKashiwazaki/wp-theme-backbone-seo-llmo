...
require_once get_template_directory() . '/inc/customizer/noindex-settings.php';
...
require_once get_template_directory() . '/inc/customizer/custom-tags-settings.php';
...
function backbone_customize_register($wp_customize) {
    ...
    backbone_add_noindex_settings($wp_customize);
    ...
    backbone_add_custom_tags_settings($wp_customize);
